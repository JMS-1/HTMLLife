$(() => {
    ...
    // Am Anfang werden alle Zellen tot angelegt.
    ...
    function schritt(): void {
        ...
        $.each(vorher,(zs, zelle) => {
            ...
            // Bei der Suche nach den Nachbarn müssen wir die Grenzen des Spielfelds beachten
    ...
    $('#random').click(() => {
        container.find('td').each((zs, zelle) => {
